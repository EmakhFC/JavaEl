...
public class Main {
    public static void main(String[] args) {
        ...
        Print.print(pc.a);
        System.out.println(pc.cnt_kills);
    }
}
class gamer {
    String[] status;
    ...
    public gamer Shoot(gamer op, int x, int y){
    ...
    public static String[][] StayShip(String[][] a, String mode){
        for (int i = 0; i<ships.length; i++) {
            while (true) {
                ...
                if (restart){
                    if (mode == "Игрок"){System.out.println("Ошибка! Попробуйте заново!");}
                    continue;
                } else {
                    if (mode == "Игрок") {
